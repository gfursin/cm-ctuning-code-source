 ...
 * to support Collective Mind Framework and Repository for automatic 
 * and collective tuning and data mining: http://c-mind.org
 *
 */
...
/* Some functions moved here by Grigori Fursin to support cM */
